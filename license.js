(function () {
  function init() {
    if (document.getElementById('_lb')) return; // zaten eklendi, tekrar ekleme
  ...
  /* ── ZAMANLAMA: hangi durum olursa olsun çalış ── */
  ...
  // BetConstruct gibi SPA/dinamik siteler için ek güvence
